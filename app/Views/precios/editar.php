    ...
    <div class="content-wrapper">
      ...
      <section class="content">
               <div class="container-fluid">
                  <div class="row">
                        <div class="col-12">               
                        <form action="<?= base_url() ?>/precios/update/<?= $datos->id ?>" method="post" >
                                    ...
                                    <div class="form-group col-4">
                                                ...
                                                <select class="form-control <?= ($validation->getError('productoid')) ? "is-invalid" : "" ?>" name="productoid" id="productoid">
                                                  ...
                                                  <?php foreach ($productos as $producto) { ?>
                                                    <option value="<?= $producto->id ?>" <?= ($producto->id == $datos->productoid ) ? "selected" : "" ?> ><?= $producto->producto ?></option>							
                                                  <?php } ?>
                                                </select> 
                                                 <!-- Error -->
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <option value="" selected disabled>---SELECCIONE PROVEEDOR--- </option>
                                                  <?php foreach ($proveedores as $proveedor) { ?>
                                                    <option value="<?= $proveedor->id ?>" <?= ($proveedor->id == $datos->proveedorid ) ? "selected" : "" ?> ><?= $proveedor->proveedor ?></option>							
                                                  <?php } ?>
                                                </select> 
                                                 <!-- Error -->
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->getError('precio')) ? "is-invalid" : "" ?>" id="precio" name="precio" placeholder="Precio producto" value="<?= $datos->precio ?>">
                                                <!-- Error -->
