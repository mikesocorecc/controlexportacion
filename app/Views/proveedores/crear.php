                                  ...
                                  <div class="card-body">                
                                      <div class="row">
                                            <div class="form-group col-4">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->getError('proveedor')) ? "is-invalid" : "" ?>" id="proveedor" name="proveedor" placeholder="Proveedor" value="">
                                                <!-- Error -->
                                                <?= ($validation->getError('proveedor')) ? "<span class='d-block error invalid-feedback'>".$validation->getError('proveedor')."</span>" : ""; ?>
                                            </div>
                                            <div class="form-group col-4">
                                                <label for="direccion">Direccion:</label>
                                                <input type="text" class="form-control <?= ($validation->getError('direccion')) ? "is-invalid" : "" ?>" id="direccion" name="direccion" placeholder="Direccion" value="">
                                                <!-- Error -->
                                                <?= ($validation->getError('direccion')) ? "<span class='d-block error invalid-feedback'>".$validation->getError('direccion')."</span>" : ""; ?>
                                            </div>
                                            <div class="form-group col-4">
                                                <label for="telefono">Telefono:</label>
                                                <input type="text" class="form-control <?= ($validation->getError('telefono')) ? "is-invalid" : "" ?>" id="telefono" name="telefono" placeholder="Telefono" value="">
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->getError('telefonoContacto')) ? "is-invalid" : "" ?>" id="telefonoContacto" name="telefonoContacto" placeholder="Telefono Contacto" value="">
                                                <!-- Error -->
