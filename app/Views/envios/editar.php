    ...
    <div class="content-wrapper">
      ...
      <section class="content">
               <div class="container-fluid">
                  <div class="row">
                        <div class="col-12">               
                        <form action="<?= base_url() ?>/envios/update/<?= $datos->id ?>" method="post" >
                                  ...
                                  <div class="card-body">                
                                    ...
                                    <input type="hidden" name="id" value="<?= $datos->id ?>">              
                                      <div class="form-group col-4">
                                          ...
                                          <option value="" selected disabled>---SELECCIONE CONTENEDOR--- </option>
                                            <?php foreach ($contenedores as $contenedor) { ?>
                                              <option value="<?= $contenedor->id ?>" <?= ($contenedor->id == $datos->contenedorid ) ? "selected" : ""  ?>><?= $contenedor->identificacion ?></option>							
                                            <?php } ?>
                                          </select> 
                                            <!-- Error -->
                                      ...
                                      <div class="form-group col-4">
                                          ...
                                          <input type="date" class="form-control <?= ($validation->getError('fechaEntrega')) ? "is-invalid" : "" ?>" id="fechaEntrega" name="fechaEntrega" placeholder="fechaEntrega" value="<?= $datos->fechaEntrega ?>">
                                          <!-- Error -->
                                      ...
                                      <div class="form-group col-4">
                                          ...
                                          <input type="text" class="form-control <?= ($validation->getError('paisDestino')) ? "is-invalid" : "" ?>" id="paisDestino" name="paisDestino" placeholder="Pais destino" value="<?= $datos->paisDestino ?>">
                                          <!-- Error -->
