 ...
 *
 * (c) Fundación CodeIgniter <admin@codeigniter.com>
 *
 * Para obtener información completa sobre derechos de autor y licencia, consulte la LICENCIA
...
/*
 * ------------------------------------------------- --------------
 * CONFIGURAR NUESTRAS CONSTANTES DE RUTA
 * ------------------------------------------------- --------------
 *
 * Las constantes de ruta brindan un acceso conveniente a las carpetas
 * en toda la aplicación. Tenemos que configurarlos aquí
 * para que estén disponibles en los archivos de configuración que se cargan.
 */
// La ruta al directorio de la aplicación.
if (! defined('APPPATH'))
{
	/**
	 * @var Paths $paths
...
//La ruta al directorio grabable.
...
//La ruta al directorio de pruebas
if (! defined('TESTPATH'))
{
	/**
	 * @var Paths $paths
